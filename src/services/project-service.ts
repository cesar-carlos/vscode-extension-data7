...
export class ProjectService {
   ...
   */
  public static findProjectPaths(filePath: string): { workspaceDir: string, projectFilePath: string } | undefined {
   ...
   */
  public static getActiveProject(): { workspaceDir: string, projectFilePath: string } | undefined {
   ...
   */
  public static async ensureExecutorPath(config: vscode.WorkspaceConfiguration): Promise<string | undefined> {
   ...
   */
  public static async protectProjectFolder(workspaceDir: string) {
   ...
   */
  public static async verifyProjectConnection(workspaceDir: string, projectFilePath: string) {
